...
#include "../../lab4/elevator/button.h"
...
QT_MOC_LITERAL(1, 7, 15), // "elevator_called"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 5), // "floor"
QT_MOC_LITERAL(4, 30, 14), // "button_pressed"
QT_MOC_LITERAL(5, 45, 15) // "button_released"

    },
    "Button\0elevator_called\0\0floor\0"
    "button_pressed\0button_released"
};
...
void Button::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->elevator_called((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Button::elevator_called)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Button::elevator_called(int _t1)
{
